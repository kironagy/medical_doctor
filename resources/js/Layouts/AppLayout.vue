      ...
      <div class="p-4 mt-auto mb-2 mx-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm">
        ...
        <div class="space-y-1 border-t border-slate-100 dark:border-slate-800 pt-2 mb-2">
          <button
            ...
            class="w-full flex items-center gap-3 text-right text-sm text-slate-700 dark:text-slate-300 font-medium hover:text-primary-600 dark:hover:text-primary-400 p-2.5 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl transition-colors"
          >
