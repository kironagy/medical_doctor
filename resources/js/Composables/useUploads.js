...
// ── FIX-ARCH-6: Read Bearer token per request via request interceptor ─────────────
// Prevents module-load token snapshotting bug where logins occurring after
// page load had no token attached to subsequent uploads.
